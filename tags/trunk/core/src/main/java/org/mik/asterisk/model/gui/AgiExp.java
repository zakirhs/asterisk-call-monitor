 ...
 * AgiExp.java
 *
 * Created on February 18, 2006, 12:46 AM
 */

package org.mik.asterisk.model.gui;
    ...
    public class TwoPartiesCallsTableModel extends AbstractTableModel { 
    	...
    	public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            case 0:                    
                return call.getId();
            case 1:
                return call.getDialingChannel().getDescriptor().getEndpoint().getId();
            case 2:
                return call.getDialedChannel().getDescriptor().getEndpoint().getId();                    
            case 3:
                switch (call.getState()) {
                    case Call.IDLE_STATE: return "IDLE";
                    case Call.CONNECTING_STATE: return "CONNECTING";
